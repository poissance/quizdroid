...
public class TopicsHome extends ActionBarActivity {
    ...
    public void onClick(View v) {
        Intent toQuizGiver = new Intent(TopicsHome.this, QuizGiver.class);
        ...
        toQuizGiver.putStringArrayListExtra("TopicContent", topicContent);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_topics_home, menu);
        return true;
    }
